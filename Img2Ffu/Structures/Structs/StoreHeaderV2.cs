...
namespace Img2Ffu.Structures.Structs
{
    ...
    {
        public ushort NumOfStores; // Total number of stores (V2 only)
        ...
        public override readonly string ToString() => $"{{NumOfStores: {NumOfStores}, StoreIndex: {StoreIndex}, StorePayloadSize: {StorePayloadSize}, DevicePathLength: {DevicePathLength}}}";
    }
}